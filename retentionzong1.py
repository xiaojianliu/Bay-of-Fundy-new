...
axes[0,0].legend()
axes[0,0].set_title('particle retention(3/31 to 6/14) at 1 meter')
axes[0,1].set_title('particle retention(6/14 to 7/14) at 1 meter')
axes[1,0].set_title('the number of partitle to south(3/31 to 6/14) at 1 meter')
axes[1,1].set_title('the number of partitle to south(6/14 to 7/14) at 1 meter')

axes[2,0].set_title('the number of partitle to north(3/31 to 6/14) at 1 meter')
axes[2,1].set_title('the number of partitle to north(6/14 to 7/14) at 1 meter')
