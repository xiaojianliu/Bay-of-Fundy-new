...
starttime=dt.datetime(2014,5,22,0,0,0,0)
endtime=dt.datetime(2014,11,22,0,0,0,0)++timedelta(hours=15*24)
...
for a in np.arange(len(num)):
    ...
    ustress.append(ss)
    vstress.append(ss1)
np.save('uwind_stress20141122',ustress)
np.save('vwind_stress20141122',vstress)
