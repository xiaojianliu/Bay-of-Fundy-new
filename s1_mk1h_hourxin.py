...
# record must be long enogh for interpolation to work  
    lon=[]
    lat=[]
    if  abs(depd)==15. or abs(depd)==1.:
        
        for mm in np.arange(len(td)):
            if td[mm]>RataDie(1978,4,1) and td[mm]<RataDie(1978,9,1) and latd[mm]>43.915 and latd[mm]<45.33 and lond[mm]>-67.875 and lond[mm]<-64.75 and len(td)>3:
                print mm
                lon.append(lond[mm])
                lat.append(latd[mm])
        for mm in np.arange(len(td)):
            if td[mm]>RataDie(1979,4,1) and td[mm]<RataDie(1979,9,1) and len(td)>3 and latd[mm]>43.915 and latd[mm]<45.33 and lond[mm]>-67.875 and lond[mm]<-64.75:
                print mm
                lon.append(lond[mm])
                lat.append(latd[mm])
        for mm in np.arange(len(td)):
            if td[mm]>RataDie(1980,4,1) and td[mm]<RataDie(1980,9,1) and len(td)>3 and latd[mm]>43.915 and latd[mm]<45.33 and lond[mm]>-67.875 and lond[mm]<-64.75:
                print mm
                lon.append(lond[mm])
                lat.append(latd[mm])
        for mm in np.arange(len(td)):
            if td[mm]>RataDie(1981,4,1) and td[mm]<RataDie(1981,9,1) and len(td)>3 and latd[mm]>43.915 and latd[mm]<45.33 and lond[mm]>-67.875 and lond[mm]<-64.75:
                print mm
                lon.append(lond[mm])
                lat.append(latd[mm])
        for mm in np.arange(len(td)):
            if td[mm]>RataDie(1982,4,1) and td[mm]<RataDie(1982,9,1) and len(td)>3 and latd[mm]>43.915 and latd[mm]<45.33 and lond[mm]>-67.875 and lond[mm]<-64.75:
                print mm
                lon.append(lond[mm])
                lat.append(latd[mm])
        for mm in np.arange(len(td)):
            if td[mm]>RataDie(1983,4,1) and td[mm]<RataDie(1983,9,1) and len(td)>3 and latd[mm]>43.915 and latd[mm]<45.33 and lond[mm]>-67.875 and lond[mm]<-64.75:
                print mm
                lon.append(lond[mm])
                lat.append(latd[mm])
        for mm in np.arange(len(td)):
            if td[mm]>RataDie(1984,4,1) and td[mm]<RataDie(1984,9,1) and len(td)>3 and latd[mm]>43.915 and latd[mm]<45.33 and lond[mm]>-67.875 and lond[mm]<-64.75:
                print mm
                lon.append(lond[mm])
                lat.append(latd[mm])
        for mm in np.arange(len(td)):
            if td[mm]>RataDie(1985,4,1) and td[mm]<RataDie(1985,9,1) and len(td)>3 and latd[mm]>43.915 and latd[mm]<45.33 and lond[mm]>-67.875 and lond[mm]<-64.75:
                print mm
                lon.append(lond[mm])
                lat.append(latd[mm])
        for mm in np.arange(len(td)):
            if td[mm]>RataDie(1986,4,1) and td[mm]<RataDie(1986,9,1) and len(td)>3 and latd[mm]>43.915 and latd[mm]<45.33 and lond[mm]>-67.875 and lond[mm]<-64.75:
                print mm
                lon.append(lond[mm])
                lat.append(latd[mm])
        for mm in np.arange(len(td)):
            if td[mm]>RataDie(1987,4,1) and td[mm]<RataDie(1987,9,1) and len(td)>3 and latd[mm]>43.915 and latd[mm]<45.33 and lond[mm]>-67.875 and lond[mm]<-64.75:
                print mm
                lon.append(lond[mm])
                lat.append(latd[mm])
        for mm in np.arange(len(td)):
            if td[mm]>RataDie(1988,4,1) and td[mm]<RataDie(1988,9,1) and len(td)>3 and latd[mm]>43.915 and latd[mm]<45.33 and lond[mm]>-67.875 and lond[mm]<-64.75:
                print mm
                lon.append(lond[mm])
                lat.append(latd[mm])
        for mm in np.arange(len(td)):
            if td[mm]>RataDie(1989,4,1) and td[mm]<RataDie(1989,9,1) and len(td)>3 and latd[mm]>43.915 and latd[mm]<45.33 and lond[mm]>-67.875 and lond[mm]<-64.75:
                print mm
                lon.append(lond[mm])
                lat.append(latd[mm])
        for mm in np.arange(len(td)):
            if td[mm]>RataDie(1990,4,1) and td[mm]<RataDie(1990,9,1) and len(td)>3 and latd[mm]>43.915 and latd[mm]<45.33 and lond[mm]>-67.875 and lond[mm]<-64.75:
                print mm
                lon.append(lond[mm])
                lat.append(latd[mm])
        for mm in np.arange(len(td)):
            if td[mm]>RataDie(1991,4,1) and td[mm]<RataDie(1991,9,1) and len(td)>3 and latd[mm]>43.915 and latd[mm]<45.33 and lond[mm]>-67.875 and lond[mm]<-64.75:
                print mm
                lon.append(lond[mm])
                lat.append(latd[mm])
        for mm in np.arange(len(td)):
            if td[mm]>RataDie(1992,4,1) and td[mm]<RataDie(1992,9,1) and len(td)>3 and latd[mm]>43.915 and latd[mm]<45.33 and lond[mm]>-67.875 and lond[mm]<-64.75:
                print mm
                lon.append(lond[mm])
                lat.append(latd[mm])
        for mm in np.arange(len(td)):
            if td[mm]>RataDie(1993,4,1) and td[mm]<RataDie(1993,9,1) and len(td)>3 and latd[mm]>43.915 and latd[mm]<45.33 and lond[mm]>-67.875 and lond[mm]<-64.75:
                print mm
                lon.append(lond[mm])
                lat.append(latd[mm])
        for mm in np.arange(len(td)):
            if td[mm]>RataDie(1994,4,1) and td[mm]<RataDie(1994,9,1) and len(td)>3 and latd[mm]>43.915 and latd[mm]<45.33 and lond[mm]>-67.875 and lond[mm]<-64.75:
                print mm
                lon.append(lond[mm])
                lat.append(latd[mm])
        for mm in np.arange(len(td)):
            if td[mm]>RataDie(1995,4,1) and td[mm]<RataDie(1995,9,1) and len(td)>3 and latd[mm]>43.915 and latd[mm]<45.33 and lond[mm]>-67.875 and lond[mm]<-64.75:
                print mm
                lon.append(lond[mm])
                lat.append(latd[mm])
        for mm in np.arange(len(td)):
            if td[mm]>RataDie(1996,4,1) and td[mm]<RataDie(1996,9,1) and len(td)>3 and latd[mm]>43.915 and latd[mm]<45.33 and lond[mm]>-67.875 and lond[mm]<-64.75:
                print mm
                lon.append(lond[mm])
                lat.append(latd[mm])
        for mm in np.arange(len(td)):
            if td[mm]>RataDie(1997,4,1) and td[mm]<RataDie(1997,9,1) and len(td)>3 and latd[mm]>43.915 and latd[mm]<45.33 and lond[mm]>-67.875 and lond[mm]<-64.75:
                print mm
                lon.append(lond[mm])
                lat.append(latd[mm])
        for mm in np.arange(len(td)):
            if td[mm]>RataDie(1998,4,1) and td[mm]<RataDie(1998,9,1) and len(td)>3 and latd[mm]>43.915 and latd[mm]<45.33 and lond[mm]>-67.875 and lond[mm]<-64.75:
                print mm
                lon.append(lond[mm])
                lat.append(latd[mm])
        for mm in np.arange(len(td)):
            if td[mm]>RataDie(1999,4,1) and td[mm]<RataDie(1999,9,1) and len(td)>3 and latd[mm]>43.915 and latd[mm]<45.33 and lond[mm]>-67.875 and lond[mm]<-64.75:
                print mm
                lon.append(lond[mm])
                lat.append(latd[mm])
        for mm in np.arange(len(td)):
            if td[mm]>RataDie(2000,4,1) and td[mm]<RataDie(2000,9,1) and len(td)>3 and latd[mm]>43.915 and latd[mm]<45.33 and lond[mm]>-67.875 and lond[mm]<-64.75:
                print mm
                lon.append(lond[mm])
                lat.append(latd[mm])
        for mm in np.arange(len(td)):
            if td[mm]>RataDie(2001,4,1) and td[mm]<RataDie(2001,9,1) and len(td)>3 and latd[mm]>43.915 and latd[mm]<45.33 and lond[mm]>-67.875 and lond[mm]<-64.75:
                print mm
                lon.append(lond[mm])
                lat.append(latd[mm])
        for mm in np.arange(len(td)):
            if td[mm]>RataDie(2002,4,1) and td[mm]<RataDie(2002,9,1) and len(td)>3 and latd[mm]>43.915 and latd[mm]<45.33 and lond[mm]>-67.875 and lond[mm]<-64.75:
                print mm
                lon.append(lond[mm])
                lat.append(latd[mm])
        for mm in np.arange(len(td)):
            if td[mm]>RataDie(2003,4,1) and td[mm]<RataDie(2003,9,1) and len(td)>3 and latd[mm]>43.915 and latd[mm]<45.33 and lond[mm]>-67.875 and lond[mm]<-64.75:
                print mm
                lon.append(lond[mm])
                lat.append(latd[mm])
        
        for mm in np.arange(len(td)):
            if td[mm]>RataDie(2004,4,1) and td[mm]<RataDie(2004,9,1) and len(td)>3 and latd[mm]>43.915 and latd[mm]<45.33 and lond[mm]>-67.875 and lond[mm]<-64.75:
                print mm
                lon.append(lond[mm])
                lat.append(latd[mm])
        for mm in np.arange(len(td)):
            if td[mm]>RataDie(2005,4,1) and td[mm]<RataDie(2005,9,1) and len(td)>3 and latd[mm]>43.915 and latd[mm]<45.33 and lond[mm]>-67.875 and lond[mm]<-64.75:
                print mm
                lon.append(lond[mm])
                lat.append(latd[mm])
        for mm in np.arange(len(td)):
            if td[mm]>RataDie(2006,4,1) and td[mm]<RataDie(2006,9,1) and len(td)>3 and latd[mm]>43.915 and latd[mm]<45.33 and lond[mm]>-67.875 and lond[mm]<-64.75:
                print mm
                lon.append(lond[mm])
                lat.append(latd[mm])
        for mm in np.arange(len(td)):
            if td[mm]>RataDie(2007,4,1) and td[mm]<RataDie(2007,9,1) and len(td)>3 and latd[mm]>43.915 and latd[mm]<45.33 and lond[mm]>-67.875 and lond[mm]<-64.75:
                print mm
                lon.append(lond[mm])
                lat.append(latd[mm])
        for mm in np.arange(len(td)):
            if td[mm]>RataDie(2008,4,1) and td[mm]<RataDie(2008,9,1) and len(td)>3 and latd[mm]>43.915 and latd[mm]<45.33 and lond[mm]>-67.875 and lond[mm]<-64.75:
                print mm
                lon.append(lond[mm])
                lat.append(latd[mm])
        for mm in np.arange(len(td)):
            if td[mm]>RataDie(2009,4,1) and td[mm]<RataDie(2009,9,1) and len(td)>3 and latd[mm]>43.915 and latd[mm]<45.33 and lond[mm]>-67.875 and lond[mm]<-64.75:
                print mm
                lon.append(lond[mm])
                lat.append(latd[mm])
        for mm in np.arange(len(td)):
            if td[mm]>RataDie(2010,4,1) and td[mm]<RataDie(2010,9,1) and len(td)>3 and latd[mm]>43.915 and latd[mm]<45.33 and lond[mm]>-67.875 and lond[mm]<-64.75:
                print mm
                lon.append(lond[mm])
                lat.append(latd[mm])
        plt.plot(lon,lat)
