...
starttime=dt.datetime(2005,4,30,0,0,0,0)
endtime=dt.datetime(2005,4,30,0,0,0,0)++timedelta(hours=15*24)
...
for a in np.arange(len(num)):
    ...
    ustress.append(ss)
    vstress.append(ss1)
np.save('uwind_stress2005430',ustress)
np.save('vwind_stress2005430',vstress)
