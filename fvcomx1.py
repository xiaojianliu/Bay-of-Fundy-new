...
starttime=dt.datetime(2008,4,30,0,0,0,0)
endtime=dt.datetime(2008,4,30,0,0,0,0)++timedelta(hours=15*24)
...
for a in np.arange(0,2000,1):
    ...
    ustress.append(ss)
    vstress.append(ss1)
np.save('uwind_stress2008',ustress)
np.save('vwind_stress2008',vstress)
